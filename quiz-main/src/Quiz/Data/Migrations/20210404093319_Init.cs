    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Studiorums", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudiorumId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Questions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Questions_Studiorums_StudiorumId",
                        column: x => x.StudiorumId,
                        principalTable: "Studiorums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizInstances_Studiorums_StudiorumId",
                        column: x => x.StudiorumId,
                        principalTable: "Studiorums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnswerInstances_Players_PlayerId",
                        column: x => x.PlayerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerInstances_PlayerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_StudiorumId",
                table: "Questions",
                column: "StudiorumId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizInstances_StudiorumId",
                table: "QuizInstances",
                column: "StudiorumId");
        }
